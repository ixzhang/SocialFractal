...
#'
#' This function computes the number of relationships in different tiers for each individual across time points.
#' The relationships are categorized based on Jenks breakpoints and gender (same or different sex).
#' @param social_networks A 3D array containing social network data. Dimensions: [individuals, individuals, time]
#' @param breakpoints_df A data.frame containing Jenks breakpoints for each individual and time point.
#'
#' @return A data.frame with relationship counts for each tier and gender category.
#' @export
#'
#' @examples
#' # Example usage:
